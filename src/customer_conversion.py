...
def plot_feature_distributions(df):
    ...
    _, axes = plt.subplots(nrows=1, ncols=len(numerical_features), figsize=(20, 5))
...
if __name__ == "__main__":
    # Example usage
    file_path = r"C:\Users\IfeomaAugustaAdigwe\Desktop\customer_conversion\data\week2_marketing_data.csv" 
    try:
